...
export async function createIngredientService(name, userId) {
...
export async function getIngredientsService(userId) {
...
export async function updateIngredientService(id, name, userId) {
    const restaurant = await prisma.restaurant.findFirst({
        where: {
            ownerId: userId
        }
...
export async function deleteIngredientService(id, userId) {
    const restaurant = await prisma.restaurant.findFirst({
        where: {
            ownerId: userId
        }
